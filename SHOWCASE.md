...
_Compiled from a full code survey; rev 2026-07-06 - 321 tests, post-adversarial-review + superfan feature audit. The share-with-people list._
...
- **SLOTS** - the classic: three portrait reels, triple angry Voltorb pays 100×, and the RTP is a fixed, fully enumerable **457/512 (~89%)** - no config, no rigging, pinned by a unit test
- **VIBE CHECK** - free press-your-luck deck: 12 cards, 4 sour; every happy face doubles the pot (128 max), the first frown torches it, a live odds panel shows the next-draw sour chance, cash out between draws
...
- /gp perf self-profiling (flame graphs), JSONL observability log, 321 unit tests
