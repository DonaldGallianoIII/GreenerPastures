package com.deuce.shinyegg;

import com.deuce.shinyegg.mixin.HandledScreenMixin;
...
public class ShinyEggHighlighterClient implements ClientModInitializer {
    ...
    // --- debug dump -----------------------------------------------------------
    private void dumpHeldItem(MinecraftClient client) {
