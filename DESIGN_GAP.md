...
| **More augments** (IV Floor, Fine-Tune/EV, Enrichment, Drop Rate, Drop Yield = v1; Nature/Egg-Move/Ability/Gender/Hatch-Speed/Clutch/Anomaly = backlog) | 🟡 | **Shiny / Speed / Enrichment / Drop Rate / Drop Yield** are craftable Compiler augments with live effects + tether-amp. **IV Floor / EV** are catalog-modeled but have no effect yet → not craftable until wired. Rest = backlog. |
