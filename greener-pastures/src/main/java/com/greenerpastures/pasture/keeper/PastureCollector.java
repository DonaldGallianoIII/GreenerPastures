 ...
 *
 * <p>Opt-in: if no adjacent inventory exists, it does nothing and loot drops normally. The chest is
 * the "collection GUI" — just open it. Called at the pasture's own check cadence ({@code checkPokemon}).
 */
